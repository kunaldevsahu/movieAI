...
#     Returns full YouTube URL or None if not found.
#     """
#     try:
#         videos_data = await tmdb_get(f"/movie/{tmdb_id}/videos", {})
#         results = videos_data.get("results", [])
        
#         # Priority 1: Official trailers on YouTube
#         trailers = [
#             v for v in results 
#             if v.get("site") == "YouTube" and v.get("type") == "Trailer"
#         ]
#         if trailers:
#             video_key = trailers[0]["key"]
#             return {
#                 "success": True,
...
#         # Priority 2: Teasers on YouTube
#         teasers = [
#             v for v in results 
#             if v.get("site") == "YouTube" and v.get("type") == "Teaser"
#         ]
#         if teasers:
#             video_key = teasers[0]["key"]
#             return {
#                 "success": True,
#                 "url": f"https://www.youtube.com/watch?v={video_key}",
#                 "embed_url": f"https://www.youtube.com/embed/{video_key}",
#                 "video_key": video_key,
#                 "name": teasers[0].get("name", "Teaser"),
#                 "type": "YouTube"
#             }
...
#         if youtube_videos:
#             video_key = youtube_videos[0]["key"]
#             return {
#                 "success": True,
#                 "url": f"https://www.youtube.com/watch?v={video_key}",
#                 "embed_url": f"https://www.youtube.com/embed/{video_key}",
#                 "video_key": video_key,
#                 "name": youtube_videos[0].get("name", "Video"),
#                 "type": "YouTube"
#             }
...
def build_response(video, label):
    key = video["key"]
    return {
        "success": True,
        ...
        "video_key": key,
        "name": video.get("name", label),
        "type": "YouTube",
        "thumbnail": f"https://img.youtube.com/vi/{key}/hqdefault.jpg"
    }
...
async def get_trailer(tmdb_id: int):
    try:
        ...
        for p_type in priority_order:
            vids = [
                v for v in results
                if v.get("site") == "YouTube" and v.get("type") == p_type
            ]
            vids = sort_videos(vids)
            if vids:
                return build_response(vids[0], p_type)

        return {
            "success": False,
            "message": "No trailer found",
            "available_types": list(set(v.get("type") for v in results))
        }
